          ...
          <section id="about" className="py-24 px-6 md:px-16 lg:px-24 bg-[#0D1528]">
                <div className="max-w-6xl mx-auto">
                        ...
                        <motion.p
                                    ...
                                    className="font-mono text-xs text-[#00CFDA] tracking-widest mb-2">// about me</motion.p>motion.p>
                        ...
                        <motion.h2
                                  ...
                                  Who I <span className="text-[#4A8BF4]">Am</span>span>
                        </motion.h2>motion.h2>
                          ...
                          {/* Left — text */}
                                  <motion.div
                                              ...
                                              <p className="text-[#7A8BAD] font-light leading-relaxed mb-5">
                                                            I'm a <strong className="text-[#E8EDF8] font-medium">Generative AI Developer</strong>strong> at Virtusa, where I design and
                                                            ship intelligent applications — from enterprise RAG systems to LLM-powered internal tools — that solve real operational
                                                            problems at scale.
                                              </p>p>
                                              <p className="text-[#7A8BAD] font-light leading-relaxed mb-5">
                                                            My background bridges two worlds: <strong className="text-[#E8EDF8] font-medium">modern AI engineering</strong>strong> (LLMs,
                                                            vector search, agentic workflows) and <strong className="text-[#E8EDF8] font-medium">battle-tested backend development</strong>strong> (Oracle
                                  ...
                                  <motion.div
                                    ...
                                    {certifications.map((c, i) => (
                                                                <div key={i} className="flex items-start gap-4 bg-[#0F1C34] border border-[rgba(74,139,244,0.15)]
                                                                                ...
                                                                                <div>
                                                                                                  <p className="font-mono text-xs text-[#7A8BAD] mb-0.5">{c.label}</p>p>
                                                                                                  <p className="text-sm font-medium text-[#E8EDF8]">{c.name}</p>p>
                                                                                </div>div>
                                                                </div>div>
                                                              ))}
                                  </motion.div>motion.div>
