    ...
    <section id="about" className="py-24 px-6 md:px-16 lg:px-24 bg-[#0D1528]">
      <div ref={ref} className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          {/* Left — text */}
          <motion.div initial={{ opacity: 0, x: -20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: .6, delay: .2 }}>
          ...
          {/* Right — certs */}
          <motion.div initial={{ opacity: 0, x: 20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: .6, delay: .3 }}
