    ...
    <section id="skills" className="py-24 px-6 md:px-16 lg:px-24 bg-[#060C1A]">
      <div ref={ref} className="max-w-6xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: .5 }}
          className="font-mono text-xs text-[#00CFDA] tracking-widest mb-2">// technical skills</motion.p>
        ...
        <motion.h2 initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: .5, delay: .1 }}
          ...
          Tech <span className="text-[#4A8BF4]">Stack</span>
        </motion.h2>
          ...
          {skillData.map((card, i) => (
            <motion.div key={card.category}
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="font-medium text-sm text-[#E8EDF8]">{card.category}</span>
              </div>
