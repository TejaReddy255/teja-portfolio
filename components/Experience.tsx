          ...
          <section id="experience" className="py-24 px-6 md:px-16 lg:px-24 bg-[#0D1528]">
                <div className="max-w-4xl mx-auto">
                        ...
                        <motion.p
                                    ...
                                    transition={{ duration: .55, delay: 0 }}
                                    className="font-mono text-xs text-[#00CFDA] tracking-widest mb-2">// work experience</motion.p>motion.p>
                
                        <motion.h2
                                    initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp}
                                    transition={{ duration: .55, delay: .1 }}
                                    className="font-display font-bold text-3xl md:text-4xl tracking-tight mb-14">
                                  Career <span className="text-[#4A8BF4]">Timeline</span>span>
                        </motion.h2>motion.h2>
                        ...
                        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px
                          ...
                          {/* Virtusa header */}
                                  <motion.div
                                              ...
                                              <p className="font-display font-bold text-xl text-[#E8EDF8]">Virtusa</p>p>
                                              <p className="font-mono text-xs text-[#7A8BAD] mt-0.5">AI Engineer &amp; Oracle PL/SQL Developer · June 2022 – Present</p>p>
                                  ...
                                  <motion.div
                                              ...
                                              <div className="bg-[#0F1C34] border border-[rgba(74,139,244,0.15)] rounded-2xl p-6">
                                                            <div className="flex justify-between items-start flex-wrap gap-2 mb-2">
                                                                            <p className="font-display font-bold text-base text-[#E8EDF8]">Generative AI Developer</p>p>
                                                                            <span className="font-mono text-xs text-[#7A8BAD]">2024 – Present</span>span>
                                                            </div>div>
                                                            <p className="text-sm text-[#4A8BF4] mb-4">Virtusa – Internal R&amp;D &amp; Innovation Projects</p>p>
                                                            ...
                                                            <p className="font-mono text-xs text-[#00CFDA] italic mb-2">Project 1: Policy Document RAG Application</p>p>
                                                              ...
                                                              {[
                                                                    ...
                                                                    'Prompt engineering to minimise hallucination and enforce policy-grounded responses with source citations',
                                                                                      ...
                                                                                      <li key={i} className="flex items-start gap-2 text-sm text-[#7A8BAD] font-light">
                                                                                                          <span className="text-[#4A8BF4] mt-0.5 text-xs flex-shrink-0">▸</span>span>{b}
                                                                                        </li>li>
                                                                                    ))}
                                                            </ul>ul>
                                              
                                                            <p className="font-mono text-xs text-[#00CFDA] italic mb-2">Project 2: Intelligent Resume Builder (Virtusa JD Format)</p>p>
                          ...
                          {/* PL/SQL band */}
                                  <motion.div
                                                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp}
                                                transition={{ duration: .55, delay: .4 }}
                                                className="relative">
                                                                      ...
                                                                      bullets: [
                                                                                  ...
                                                                                  <div key={i} className={i > 0 ? 'pt-5 border-t border-[rgba(74,139,244,0.1)]' : ''}>
                                                                                                    <div className="flex justify-between items-start flex-wrap gap-2 mb-1">
                                                                                                                        <p className="font-display font-bold text-base text-[#E8EDF8]">{exp.role}</p>p>
                                                                                                                        <span className="font-mono text-xs text-[#7A8BAD]">{exp.dates}</span>span>
                                                                                                      </div>div>
                                                                                                    <p className="text-sm text-[#F5A623] mb-3">{exp.org}</p>p>
                                                                                                    <ul className="space-y-1.5">
                                                                                                      {exp.bullets.map((b, j) => (
                                                                                                          <li key={j} className="flex items-start gap-2 text-sm text-[#7A8BAD] font-light">
                                                                                                                                  <span className="text-[#F5A623] mt-0.5 text-xs flex-shrink-0">▸</span>span>{b}
                                                                                                            </li>li>
                                                                                                        ))}
                                                                                                      </ul>ul>
                                                                                  </div>div>
