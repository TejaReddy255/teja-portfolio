    ...
    <section id="experience" className="py-24 px-6 md:px-16 lg:px-24 bg-[#0D1528]">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          className="font-mono text-xs text-[#00CFDA] tracking-widest mb-2">// work experience</motion.p>
        ...
        <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px
          ...
          <motion.div
            ...
            <p className="font-mono text-xs text-[#7A8BAD] mt-0.5">AI Engineer &amp; Oracle PL/SQL Developer &middot; June 2022 &ndash; Present</p>
          </motion.div>
          ...
          <motion.div
            ...
            <span className="inline-flex items-center gap-2 font-mono text-xs text-[#4A8BF4] bg-[rgba(74,139,244,0.1)]
              ...
              &#9889; Gen AI Development &mdash; 2024&ndash;Present
            </span>
            ...
            <div className="bg-[#0F1C34] border border-[rgba(74,139,244,0.15)] rounded-2xl p-6">
              <div className="flex justify-between items-start flex-wrap gap-2 mb-2">
                ...
                <span className="font-mono text-xs text-[#7A8BAD]">2024 &ndash; Present</span>
              </div>
              <p className="text-sm text-[#4A8BF4] mb-4">Virtusa &ndash; Internal R&amp;D &amp; Innovation Projects</p>
              <p className="text-sm text-[#7A8BAD] font-light leading-relaxed mb-5">
                Led development of internal Gen AI applications at Virtusa &mdash; automating knowledge retrieval, streamlining
          ...
          <motion.div
            ...
            <span className="inline-flex items-center gap-2 font-mono text-xs text-[#F5A623] bg-[rgba(245,166,35,0.1)]
              ...
              Oracle PL/SQL Development &mdash; July 2022&ndash;June 2024
            </span>
              ...
              {[
                {
                  ...
                  org: 'Citibank N.A. &ndash; Procure to Pay (P2P)',
                  dates: 'July 2023 &ndash; June 2024',
                  bullets: [
                ...
                {
                  role: 'Oracle PL/SQL Developer',
                  org: 'Citicorp Finance India Ltd. &ndash; CITI ABF',
                  dates: 'July 2022 &ndash; June 2023',
                  bullets: [
                ...
                <div key={i} className={i > 0 ? 'pt-5 border-t border-[rgba(74,139,244,0.1)]' : ''}>
                  <div className="flex justify-between items-start flex-wrap gap-2 mb-1">
                    ...
                    <span className="font-mono text-xs text-[#7A8BAD]" dangerouslySetInnerHTML={{ __html: exp.dates }} />
                  </div>
                  <p className="text-sm text-[#F5A623] mb-3" dangerouslySetInnerHTML={{ __html: exp.org }} />
                  <ul className="space-y-1.5">
                    {exp.bullets.map((b, j) => (
