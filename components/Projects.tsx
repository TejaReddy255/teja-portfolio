          ...
          <section id="projects" className="py-24 px-6 md:px-16 lg:px-24 bg-[#060C1A]">
                <div className="max-w-6xl mx-auto">
                        ...
                        <motion.p
                                    ...
                                    className="font-mono text-xs text-[#00CFDA] tracking-widest mb-2">// key projects</motion.p>motion.p>
                        ...
                        <motion.h2
                                  ...
                                  What I've <span className="text-[#4A8BF4]">Built</span>span>
                        </motion.h2>motion.h2>
                        ...
                        <motion.div key={p.num}
                          ...
                          {/* top accent line */}
                                      ...
                                      <div className="flex justify-between items-start mb-4">
                                                      <span className="font-mono text-xs text-[#7A8BAD] bg-[#060C1A] px-2 py-1 rounded">{p.num}</span>span>
                                                      <span className="font-mono text-xs text-[#00CFDA] bg-[rgba(0,207,218,0.08)]
                                                        border border-[rgba(0,207,218,0.2)] px-2.5 py-1 rounded-full">{p.type}</span>span>
                                      </div>div>
                        
                                      <h3 className="font-display font-bold text-base text-[#E8EDF8] mb-3 tracking-tight">{p.title}</h3>h3>
                                      <p className="text-sm text-[#7A8BAD] font-light leading-relaxed mb-5">{p.desc}</p>p>
