...
export function Footer() {
  return (
    <footer className="bg-[#060C1A] border-t border-[rgba(74,139,244,0.1)] px-6 md:px-16 lg:px-24 py-6
      ...
      <p className="font-mono text-xs text-[#7A8BAD]">&copy; 2026 Annem Siva Sai Teja Reddy</p>
      <p className="font-mono text-xs text-[#4A8BF4]">Gen AI Developer &middot; Hyderabad</p>
    </footer>
  )
}
